...
const Portfolio = () => {
  return (
    <body name='portfolio' className="mt-10 p-24">
    ...
    <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-10 flex-col w-full">
      ...
      <div className='p-5 border-b-2 border-slate-600 pb-10'>
        <h1 className='text-3xl font-bold text-white'>Crowdfunding site: <span className='text-purple-400'>FutureProofME</span></h1>
      ...
      className='text-purple-400'>Buybuddy Shopping Lists</span></h1>
        ...
        <button className='hover:bg-[#AC34FF] bg-fuchsia-400  w-[150px] 
          rounded-full font-bold py-2 m-2 text-white text-lg'><a href='https://main--polite-macaron-a4389b.netlify.app/login'>Live website</a></button>
        <button className='hover:bg-[#AC34FF] bg-fuchsia-400  w-[150px] 
